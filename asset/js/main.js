...
function initDropdowns() {
    ...
    dropdownToggles.forEach(toggle => {
        toggle.addEventListener('click', function(e) {
            ...
            document.querySelectorAll('.nav_dropdown').forEach(item => {
                if (item !== parent) {
                    item.classList.remove('nav_dropdown-active');
                }
            });
            
            // Toggle this dropdown
            parent.classList.toggle('nav_dropdown-active');
            console.log('Dropdown toggled:', parent.classList.contains('nav_dropdown-active'));
        });
    });
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('.nav_dropdown')) {
            document.querySelectorAll('.nav_dropdown').forEach(dropdown => {
                dropdown.classList.remove('nav_dropdown-active');
            });
        }
    });
}
